...
public class RecursiveDoubleLinkedListImpl<T> extends
	...
	public void insert(T element) {
		if (element != null) {
			if (this.isEmpty()) {
				RecursiveDoubleLinkedListImpl<T> nilNodeL = new RecursiveDoubleLinkedListImpl<>();
				this.setData(element);
				this.setNext(nilNodeL);
				nilNodeL.setPrevious(this);

				if (this.getPrevious() == null) {
					RecursiveDoubleLinkedListImpl<T> nilNodeH = new RecursiveDoubleLinkedListImpl<>();
					this.setPrevious(nilNodeH);
					nilNodeH.setNext(this);
				}
